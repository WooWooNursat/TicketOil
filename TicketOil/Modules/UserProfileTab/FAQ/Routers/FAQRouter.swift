...
final class FAQRouter: Router {
    ...
    func present(on baseVC: UIViewController, animated: Bool, context: Any?, completion _: (() -> Void)?) {
        ...
        switch context {
        case .default:
            let vc = FAQViewController(navigationBarConfigurator: DIResolver.resolve(NavigationBarConfigurator.self)!)
            vc.viewModel = FAQViewModel(router: self)
